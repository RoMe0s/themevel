...
class Theme implements ThemeContract
{
    ...
    public function assets($path, $secure = null)
    {
        ...
        $themePath = str_replace($this->config['theme.theme_path'], "Themes", $themeInfo->get('path')).'/';
        ...
        if (!file_exists($fullPath) && $themeInfo->has('parent') && !empty($themeInfo->get('parent'))) {
            $themePath = str_replace($this->config['theme.theme_path'], "Themes", $this->getThemeInfo($themeInfo->get('parent'))->get('path')).'/';
            $fullPath = $themePath.$assetPath.$path;
